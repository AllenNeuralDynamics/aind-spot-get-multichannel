...
def run():
    ...
    IMAGE_PATH = (
        "s3://aind-open-data/HCR_BL6-000_2023-07-17_00-01-00_fused_2024-04-01_21-11-26"
    )
    ...
    multichannel_spots = {
        "channel_1": np.load(
            f"{DATA_FOLDER}/R13_CHs_spots/R13_channel_1_puncta_detection_results/spots.npy"
        ),
        "channel_2": np.load(
            f"{DATA_FOLDER}/R13_CHs_spots/R13_channel_2_puncta_detection_results/spots.npy"
        ),
        "channel_3": np.load(
            f"{DATA_FOLDER}/R13_CHs_spots/R13_channel_3_puncta_detection_results/spots.npy"
        ),
    }
